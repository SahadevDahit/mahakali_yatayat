...
async function getData() {
  const res = await fetch(
    `${process.env.NEXT_PUBLIC_URL}/nagadh_route_counter/get`,
    {
      next: {
        revalidate: 10,
      },
...
const nagadh_route_counter = () => {
  ...
  return (
    <div className="w-100 h-100 container">
      <h1 className="text-center">Nagadh Route Counter</h1>
      ...
      <div className="col-3">
        <Button>
          <Link
            ...
            className="float-end "
            href={{
              pathname: "/app/nagadh_route_counter",
              query: { id: "000" },
            }}
          >
            Add
